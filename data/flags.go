...
const (
	...
	TxSetDisallowZXC   TransactionFlag = 0x00000003
	...
	TxDisallowZXC      TransactionFlag = 0x00100000
	TxAllowZXC         TransactionFlag = 0x00200000
...
const (
	...
	LsDisallowZXC    LedgerEntryFlag = 0x00080000
...
var txFlagNames = map[TransactionType][]struct {
	...
	ACCOUNT_SET: {
		...
		{TxSetDisallowZXC, "SetDisallowZXC"},
